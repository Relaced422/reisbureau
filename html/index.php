...
<section class="bg-[#1e3b24] py-20 px-6">
  <div class="max-w-6xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
      <!-- AI -->
      <?php foreach ([
        ['✈️', 'Cannabis-friendly flights',  'Every flight we book allows in-flight cannabis consumption. Exhale before you even land.'],
        ['🌿', 'Pre-rolls included',          'Sourced from growers we know personally. Rolled the morning of departure. Matched to your destination.'],
      ...
      <div class="border-l-4 border-[#a3c7a7] pl-6">
        ...
        <p class="text-[#a3c7a7] text-sm leading-relaxed"><?= $text ?></p>
      </div>
      <?php endforeach; ?>
    </div>
  </div>
  ...
  <div class="max-w-6xl mx-auto">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
      <div class="md:col-span-1">
        ...
        <p class="text-sm leading-relaxed">A travel agency that partners exclusively with cannabis-friendly airlines.</p>
      </div>
      <div>
