<header class="bg-[#A3C7A7] flex items-center justify-between px-6 py-4">
    ...
    <nav>
        <ul class="kadwa flex items-center gap-15 text-xl text-white">
            <li>
                <a href="index.php"
                    class="block rounded-full bg-[#78B183] px-10 py-5 transition-all duration-300 hover:scale-105 hover:bg-[#497F53]">
                    Home
                </a>
            </li>
